...
const certificates = [
  {
    icon: <FiShield className="w-5 h-5 text-indigo-400" />,
  ...
  {
    icon: <FiCpu className="w-5 h-5 text-sky-400" />,
  ...
  {
    icon: <FiFileText className="w-5 h-5 text-emerald-400" />,
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-16 relative mb-28">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="absolute left-4 md:left-1/2 top-6 md:top-8 w-3.5 h-3.5 md:w-4 md:h-4 rounded-full bg-indigo-500 z-10 shadow-[0_0_15px_rgba(99,102,241,0.6)] border border-white/20 -translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="space-y-12">
          <div className="flex items-center gap-3 justify-center mb-10">
            <FiAward className="w-6 h-6 text-indigo-400" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {certificates.map((cert, idx) => (
              <motion.div
                key={idx}
                className="p-6 rounded-2xl border border-white/5 bg-zinc-900/40 backdrop-blur-sm flex flex-col justify-between transition-all duration-300 hover:border-indigo-500/10 hover:shadow-lg hover:shadow-indigo-500/5 group"
              ...
              >
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    <span className="text-[9px] uppercase tracking-widest text-indigo-400 font-bold bg-indigo-500/5 border border-indigo-500/10 px-2 py-0.5 rounded">
                      {cert.type}
                    </span>
                  ...
                  <div className="space-y-1.5">
                    <h4 className="text-sm font-bold text-white group-hover:text-indigo-400 transition-colors duration-300 leading-snug">
                      {cert.title}
                    </h4>
                ...
                {cert.link && (
                  <div className="pt-4 border-t border-white/5 mt-4">
                    <a
                      ...
                      className="text-xs text-indigo-400 hover:text-indigo-300 font-medium inline-flex items-center gap-1 transition-colors duration-300"
                    >
                      Audit Details &rarr;
                    </a>
                  </div>
