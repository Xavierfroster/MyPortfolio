    ...
    <section className="relative min-h-screen py-32 px-6 bg-zinc-900 flex items-center justify-center">
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-16 relative">
          {/* Vertical line */}
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-[1px] bg-zinc-700 -translate-x-1/2 hidden md:block" />
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className={`flex-1 w-full ${i % 2 === 0 ? "md:text-right" : "md:text-left"} space-y-3`}>
              ...
              <div className="hidden md:flex w-4 h-4 rounded-full bg-white z-10 shadow-[0_0_20px_rgba(255,255,255,0.5)]" />
